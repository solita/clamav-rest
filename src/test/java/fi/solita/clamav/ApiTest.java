...
@SpringBootTest(classes = { Application.class, TestConfiguration.class }, properties = {
...
public class ApiTest {
        ...
        public void postScan() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.multipart("/scan")
                                .file(testFile)
        ...
        public void postScanReply() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.multipart("/scanReply")
                                .file(testFile)
                                .param("name", "testFile.txt"))
                                .andExpect(status().isOk())
